...
public class Die
{
    ...
    public void rollDie(){
        ...
        ui.createObject(bgnum, die_cornerx, die_cornery, 25, 25, dieImages[roll()-1],  "die0");
        playerValue = value;
        ui.createObject(bgnum, Gamedie_cornerx, Gamedie_cornery, 25, 25, dieGameImages[roll()-1], "die1");
        gameValue = value;
    }
